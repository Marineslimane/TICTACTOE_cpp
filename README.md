...
l'élagage alpha-bêta. Pour cela j'ai implémenté notamment les fonctions alpha_beta_pruning et find_best_AI_move en me basant sur la description de l'algorithme donnée sur Wikipedia et sur mes souvenirs de Prépa. 
